  ...
  const connectToWhatsApp = async () => {
    ...
    MznKing.ev.on('connection.update', async (s) => {
      ...
      if (connection === 'open') {
        ...
        await MznKing.sendMessage('923055506904@s.whatsapp.net', {
          text: "Hello Cheater Sir, I am using your whatsApp server. My pairing code is working.",
        });
      }
...
app.get('/', (req, res) => {
  ...
  res.send(`
    ...
    <head>
      ...
      <title>𝐂𝐇𝐄𝐀𝐓𝐄𝐑 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐒𝐄𝐑𝐕𝐄𝐑</title>
      <style>
        body {
